...
<div class="Store" >
	<div class="row">
		...
		<input type="button" id="Send" value="Τελική Αγορά" onclick="transport();transportValidation()" >
...
<!-- FOOTER-------------------->
	...
	//μεταφορα στην σελιδα αποστολης και ελεγχος εαν ειναι μηδεν η ποσοτητα πριν γινει η μεταφορα
	function transportValidation(){
		var finalsum = document.getElementById('sumq').value; // παιρνει την στιγμαια τελικη ποσότητα
		if (finalsum <=0){
			alert("Παρακαλούμε εισάγεται προιοντα στο καλαθι!")
		}else{
